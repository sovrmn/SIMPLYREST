...
# users :
owner = User.create!(email:'mariis&luc@gmail.com', password:'nespresso')
p "users created"
# restaurant :
...
epices = Product.create!(name: '4 épices', category: 'épices', unit: 'kg')
thym =Product.create!(name: 'Thym', category: 'épices', unit: 'botte')
huileTournesol = Product.create!(name: 'Huile Tournesol', category: 'condiments' , unit: 'L' )
huileOlive = Product.create!(name: "Huile d'olive", category: 'condiments' , unit: 'L' )
farine = Product.create!(name: 'Farine', category: 'BOF', unit: 'kg')
vin = Product.create!(name: 'Vin', category: "Liquide - Alcool" , unit: 'L')
fondsVeau = Product.create!(name: 'Fonds de veau', category: 'viandes' , unit: 'kg')
pdtg = Product.create!(name: 'PDT Grenaille', category: 'légumes', unit: 'kg')
beurre = Product.create!(name: 'Beurre', category: 'BOF' , unit: 'kg')
salade = Product.create!(name: 'Salade', category: "légumes", unit: 'kg' )
fleurSel = Product.create!(name: 'Fleur de sel', category: 'épices', unit: 'kg')
# saumon
saumon = Product.create!(name: 'saumon', category: 'poissons', unit: 'kg')
citronConfit = Product.create!(name: 'citron confit', category: 'fruits', unit: 'kg')
noisette = Product.create!(name: 'noisettes', category: 'fruits à coque', unit: 'kg')
fromageFrais = Product.create!(name: 'fromage frais', category: 'crèmerie', unit: 'kg')
citronJaune = Product.create!(name: 'citron jaune', category: 'fruits', unit: 'kg')
poivre = Product.create!(name: 'Poivre', category: 'épices', unit: 'kg')
# falafel
poisChiches = Product.create!(name: 'pois chiches', category: 'légumes', unit: 'kg')
coriandre = Product.create!(name: 'coriandre', category: 'épices', unit: 'kg')
cumin = Product.create!(name: 'cumin', category: 'épices', unit: 'kg')
aubergine = Product.create!(name: 'aubergine', category: 'légumes', unit: 'kg')
ail = Product.create!(name: 'ail', category: 'légumes', unit: 'kg')
citronVert = Product.create!(name: 'citron vert', category: 'fruits', unit: 'kg')
# riz au lait
rizRond = Product.create!(name: 'riz rond', category: 'féculents', unit: 'kg')
lait = Product.create!(name: 'lait', category: 'crèmerie', unit: 'L')
sucre = Product.create!(name: 'sucre', category: 'épicerie sucrée', unit: 'kg')
mure = Product.create!(name: 'mûres sauvages', category: 'fruits', unit: 'kg')
...
thym_bourguignon = Ingredient.create!(quantity: 0.004, recipe: bourguignon, product: thym)
...
fondsVeau_bourguignon = Ingredient.create!(quantity: 0.010, recipe: bourguignon, product: fondsVeau)
...
#falafel
poisChiches_falafel = Ingredient.create!(quantity: 0.04, recipe: falafel, product: poisChiches)
...
persil_falafel = Ingredient.create!(quantity: 0.005, recipe: falafel, product: persil)
...
mures_rizLait = Ingredient.create!(quantity: 0.05, recipe: rizLait, product: mure)
...
# ? inventory_items :
boeufAubrac_inv = InventoryItem.create(quantity: 1.5,restaurant: restaurant ,product: boeufAubrac)
...
huileTournesol_inv = InventoryItem.create(quantity: 2,restaurant: restaurant ,product: huileTournesol)
...
fondsVeau_inv = InventoryItem.create(quantity: 1,restaurant: restaurant ,product: fondsVeau)
...
citronConfit_inv = InventoryItem.create(quantity: 1.4,restaurant: restaurant ,product: citronConfit)
noisette_inv = InventoryItem.create(quantity: 1.2,restaurant: restaurant ,product: noisette)
fromageFrais_inv = InventoryItem.create(quantity: 1.2,restaurant: restaurant ,product: fromageFrais)
citronJaune_inv = InventoryItem.create(quantity: 1.0,restaurant: restaurant ,product: citronJaune)
...
mure_inv = InventoryItem.create(quantity: 1.5,restaurant: restaurant ,product: mure)
...
persil_order_item = OrderItem.create(quantity: 6, unit: 'kg', price: 8.45, completed: false, supplier_item: persil_jayden, order: order_waiting_2)
...
carrotte_order_item = OrderItem.create(quantity: 8, unit: 'kg', price: 10.16, completed: false, supplier_item: carotte_metro, order: order_delivered)
...
order_item_three = OrderItem.create(quantity: 1, unit: 'kg', price: 1, completed: false, supplier_item: cote_c2b, order: order_waiting)
order_item_four = OrderItem.create(quantity: 1, unit: 'kg', price: 4, completed: false, supplier_item: boeufAubrac_c2b, order: order_waiting)
